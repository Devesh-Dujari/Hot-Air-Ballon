...
function setup() {
  ...
  balloon.scale = 0.2;
  //balloon.debug = true;
  balloon.setCollider("rectangle", 0, -30, 300, 470);
  ...
  startText =  text("Press space to start", 100, 200);
...
function draw() {
  ...
  if (keyDown("space")) {
    ...
    //adding gravity
    balloon.velocityY = balloon.velocityY + 1.75;
...
function Bar() {
  if (World.frameCount % 60 === 0) {
    var bar = createSprite(400, 200, 1, 800);
    bar.velocityX = -4;
